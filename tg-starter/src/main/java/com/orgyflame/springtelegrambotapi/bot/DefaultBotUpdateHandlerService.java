...
public class DefaultBotUpdateHandlerService implements BotUpdateHandlerService{
    ...
    public DefaultBotUpdateHandlerService(BotCallbackQueryContainer botCallbackQueryContainer, BotApiMappingContainer botApiMappingContainer, TelegramApiService telegramApiService, ModelMapper objectMapper) {
